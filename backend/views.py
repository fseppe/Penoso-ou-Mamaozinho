...
class DisciplinasInformacoes(db.Model):
    __table__ = db.Table(
        'disciplinas_informacoes', db.metadata,
...
class ComentariosInformacoes(db.Model):
    __table__ = db.Table(
        'comentarios_informacoes', db.metadata,
...
class AvaliacoesDisciplinas(db.Model):
    __table__ = db.Table(
        'avaliacoes_disciplinas', db.metadata,
        db.Column('id', db.Integer, primary_key=True),
        db.Column('id_disciplina', db.Integer),
...
class AvaliacoesComentario(db.Model):
    __table__ = db.Table(
        'avaliacoes_comentario', db.metadata,
        db.Column('id', db.Integer, primary_key=True),
